...
- Actions are messages with information to send. Reducers take the actions and previous state and return a new state. The store hold all the state for your app.

3. What is the difference between Application state and Component state? When would be a good time to use one over the other?

- Application state is global and component state is local and can only be used within that component.

4. Describe `redux-thunk`, what does it allow us to do? How does it change our `action-creators`?

- Redux-thunk is a middleware that allows your action creators to return a function instead of an action. This allows you to handle asynchronous actions.
-

5. What is your favorite state management system you've learned and this sprint? Please explain why!

- I like the Context API because it is cleaner and simpler to work with compared to redux. I like that you can do the same thing with less code.
